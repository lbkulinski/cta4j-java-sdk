...
/**
 * Represents a query for detailed train station alerts.
 *
 * @param stationIds the {@link List} of train station IDs to retrieve alerts for
 ...
 */
@NullMarked
public record StationAlertsQuery(
    ...
    /**
     * Constructs a {@code StationAlertsQuery}.
     *
     * @param stationIds the {@link List} of train station IDs to retrieve alerts for
     * @param activeOnly whether to include only alerts that are currently active
     * @param accessibility whether to include alerts that affect accessible paths in stations
    ...
    /**
     * Creates a builder for {@code StationAlertsQuery}.
     *
    ...
    /**
     * A builder for {@code StationAlertsQuery}.
     */
    public static final class Builder {
        /**
         * The {@link List} of train station IDs to retrieve alerts for.
         */
        ...
        /**
         * Builds the {@code StationAlertsQuery}.
         *
         * @return a new {@code StationAlertsQuery} instance
