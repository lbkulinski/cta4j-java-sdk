...
///
/// @param stationIds the [List] of train station IDs to retrieve alerts for
...
public record StationAlertsQuery(
    ...
    /// Constructs a `StationAlertsQuery`.
    ///
    /// @param stationIds the [List] of train station IDs to retrieve alerts for
    /// @param activeOnly whether to include only alerts that are currently active
    /// @param accessibility whether to include alerts that affect accessible paths in stations
    ...
    /// A builder for `StationAlertsQuery`.
    public static final class Builder {
        /// The [List] of train station IDs to retrieve alerts for.
