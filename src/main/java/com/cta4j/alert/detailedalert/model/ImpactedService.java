 ...
 * @param color the color of this service used in maps, as {@code rrggbb} (e.g., "565a5c")
...
public record ImpactedService(
     ...
     * @param color the color of the service used in maps, as {@code rrggbb} (e.g., "565a5c")
     * @param textColor the suggested color of text displayed against {@code color}; casing varies (e.g., "ffffff",
     *                  "FFFFFF")
