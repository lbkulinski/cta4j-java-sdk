...
public enum DetailedAlertsErrorCode {
    ...
    /**
     * Constructs a {@code DetailedAlertsErrorCode}.
     *
    ...
    /**
     * Returns the {@code DetailedAlertsErrorCode} corresponding to the given integer code.
     *
     * @param code the integer code to look up
     * @return the corresponding {@code DetailedAlertsErrorCode}, or {@code UNKNOWN} if the code does not match any
     * defined error code
     */
