...
public record LocationTrain(
    ...
    /// @throws NullPointerException if `run`, `destinationStationId`, `destinationName`, `direction`, `nextStationId`,
    /// `nextStopId`, `nextStationName`, `predictionTime`, `arrivalTime`, or `coordinates` is `null`
