...
public enum LocationsErrorCode {
    ...
    /// Indicates that the specified route is not valid or does not exist in the CTA system. Valid route identifiers
    /// are red, blue, brn, g, org, p, pink, and y. The route identifiers are case-insensitive.
    INVALID_ROUTE(106),
