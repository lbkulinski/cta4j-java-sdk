...
/// @param passengerLoad the [PassengerLoad] of the vehicle associated with this prediction
...
/// @param flagStop the [FlagStop] information of the vehicle associated with this prediction
@NullMarked
public record PredictionMetadata(
    ...
    /// @param dynamicAction the [DynamicAction] affecting the prediction
    ...
    /// @param passengerLoad the [PassengerLoad] of the vehicle associated with the prediction
    ...
    /// @param flagStop the [FlagStop] information of the vehicle associated with the prediction
    /// @throws NullPointerException if `timestamp`, `dynamicAction`, `blockId`, `tripId`, `originalTripNumber`,
    /// `zone`, `passengerLoad`, or `flagStop` is `null`
