...
///                       prediction
/// @param routeId the alphanumeric designator of the route (e.g., "20" or "X9") for which this prediction was
///                generated
/// @param routeDesignator the language-specific route designator of this prediction, intended for display; identical
///                        to `routeId` in practice (e.g., "20")
...
public record Prediction(
    ...
    /// @param distanceToStop the feet left to be traveled by the vehicle before it reaches the stop associated with
    ///                       the prediction
    ...
    ///                        identical to `routeId` in practice (e.g., "20")
