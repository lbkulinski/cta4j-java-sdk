...
/// @param designator the language-specific route designator of this route, intended for display; identical to `id` in
///                   practice (e.g., "22")
...
public record Route(
    ...
    /// @param designator the language-specific route designator of the route, intended for display; identical to `id`
    ///                   in practice (e.g., "22")
    /// @param dataFeed the data feed identifier for the route, if applicable
    /// @throws NullPointerException if `id`, `name`, `color`, or `designator` is `null`
    public Route {
