...
class StopsApiImplTest {
    ...
    @Test
    void findByRouteIdAndDirection_throwsCta4jBusException_whenResponseContainsFatalErrors() {
        this.server.stubFor(get(urlPathEqualTo("/bustime/api/v3/getstops"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
    ...
    @Test
    void findByRouteIdAndDirection_throwsCta4jBusException_whenResponseIsNotJson() {
        this.server.stubFor(get(urlPathEqualTo("/bustime/api/v3/getstops"))
            .willReturn(aResponse()
                .withStatus(200)
                .withHeader("Content-Type", "application/json")
    ...
    @Test
    void findByRouteIdAndDirection_throwsCta4jBusException_whenServerReturnsErrorStatus() {
        this.server.stubFor(get(urlPathEqualTo("/bustime/api/v3/getstops"))
            .willReturn(aResponse()
                .withStatus(500)));
